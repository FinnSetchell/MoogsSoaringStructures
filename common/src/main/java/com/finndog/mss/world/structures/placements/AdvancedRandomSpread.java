package com.finndog.mss.world.structures.placements;
...
public class AdvancedRandomSpread extends RandomSpreadStructurePlacement {
    ...
    public AdvancedRandomSpread(Vec3i locationOffset,
        ...
        this.spacing = (int)Math.round(spacing * 1.85);
        this.separation = (int)Math.round(separation * 1.85);
        ...
        if (spacing <= separation) {
            throw new RuntimeException("""
                Moog's Soaring Structures: Spacing cannot be less or equal to separation.
    ...
    public StructurePlacementType<?> type() {
        return MSSStructurePlacementType.ADVANCED_RANDOM_SPREAD.get();
    }
