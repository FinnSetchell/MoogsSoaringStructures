...
public class MirroringSingleJigsawPiece extends SinglePoolElement {
    ...
    public MirroringSingleJigsawPiece(SinglePoolElement singleJigsawPiece, Mirror mirror) {
        this(((SinglePoolElementAccessor)singleJigsawPiece).mss_getTemplate(), ((SinglePoolElementAccessor)singleJigsawPiece).mss_getProcessors(), singleJigsawPiece.getProjection(), mirror);
    }
